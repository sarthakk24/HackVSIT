...
const web3StorageClient = new Web3Storage({
  token: process.env.REACT_PUBLIC_WEB3_STORAGE_TOKEN,
...
export default function CreateShow() {
  ...
  async function addImage(){
    ...
    if(files){
      ...
      const token = process.env.REACT_PUBLIC_WEB3_STORAGE_TOKEN;
          ...
          >
            ...
            <div className="pt-5">
              <div className="flex justify-end">
                  <a href="/" className="bg-white py-2 px-4 border border-gray-300 rounded-full shadow-sm text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                    Cancel
                  </a>
                <button
                  type="submit"
